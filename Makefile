...
OBJECT_FILES = build/console.o build/main.o build/entry.asm.o build/string.o build/gdt.o build/traps.o build/io.asm.o build/keyboard.o build/unistd.o build/sched.o build/mm.o build/mm.asm.o build/traps.asm.o
...
all:
	...
	$(AS) $(AS_FLAGS) kernel/traps.asm -o build/traps.asm.o
	...
	$(LD) -m elf_i386 -Map=kernel.map -T linker.ld -o iso/boot/kernel $(OBJECT_FILES)
